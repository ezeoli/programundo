...
<nav aria-label="Page navigation example" className="inline-flex items-center justify-items-center  -space-x-px " >
  <ul className="inline-flex items-center justify-items-center  -space-x-px ">
    <li>
