...
<div id="default-carousel" className="relative w-full" data-carousel="slide">
    ...
    <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          ...
          height={500} priority={true}  className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
        ...
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
            <Image src="/programundo.jpg" width={800}
          height={800}  className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
        </div>
    </div>
