        ...
        <div className="justify-between  px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
          ...
          <div >
            <div
              ...
              ${navbar ? "p-12 md:p-0 block" : "hidden"}  h-96 `}
            >
              <ul className="flex flex-col md:flex-row h-screen md:h-auto md:justify-center items-center max-h-screen overflow-y-auto ">
                <li className="group relative dropdown">
                  ...
                  <div className="z-30 rounded-lg group-hover:block dropdown-menu absolute hidden h-auto mt-2 left-0 right-0 md:relative md:mt-0" >
