...
export default function About({}: Props) {
  return (
    <section id="about">
      ...
      <h2 className="text-4xl font-bold text-center text-transparent bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text hover:underline hover:bg-gradient-to-r hover:from-blue-500 hover:to-green-400 transition-all">
  FOX PICS
</h2>
